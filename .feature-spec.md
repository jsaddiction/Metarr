...
- [ ] Create ReadOnlyDataGrid.tsx component
- [ ] Create StatusBadge.tsx component
- [ ] Create CurrencyDisplay.tsx component
- [ ] Create PopularityIndicator.tsx component
- [ ] Update MetadataTab.tsx - add Stats section
- [ ] Update MetadataTab.tsx - add Production Info section
- [ ] Update MetadataTab.tsx - add External Links section
- [ ] Update MetadataTab.tsx - add Technical Details section
- [ ] Update MovieDetail interface (add new fields)
- [ ] Add useMovieDetail hook updates (include=streams)
