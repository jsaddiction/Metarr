        ...
        >
          <div className="space-y-6">
            ...
            <SettingRow
              ...
              description="When enabled, Metarr automatically selects the best assets. When disabled, you manually choose assets in the UI."
            >
              <Switch
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {assetLimitsByMediaType().map(([mediaType, group]) => (
                  <div key={mediaType} className="bg-background border border-neutral-700 rounded-md">
                    {/* Media Type Header */}
                    <button
                      type="button"
