    ...
    <div className={cn(
      ...
      <div className="relative flex-1">
        <input
          ...
          title={title}
          className={cn(
            "w-full h-8 pr-6 pl-2.5 py-1 text-sm bg-neutral-800 border border-l-0 rounded-r text-neutral-200 focus-visible:outline-none transition-colors disabled:opacity-50 disabled:cursor-not-allowed",
